...
export const HeaderPriv = () => {
  ...
  return ( 
    <header className="screen-max-width">
      <nav className={`flex flex-row w-full justify-between items-center py-4 max-[1260px]:px-10 ${open ? 'fixed' : ''}`}>
        {/* Mobile */}
        { open && (
              ...
              <div className="flex flex-row items-center gap-4">
                <div className="flex flex-col items-end">
                  ...
                  <li className="m-0 p-0">
                    <NavLink to="/rsocial/logout" className="text-gray-700 hover:underline font-bold text-sm">
                      Cerrar sesión
                    </NavLink>
                  </li>
                </div>
